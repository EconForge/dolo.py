...
@multimethod
def eval_is(itp: object, exo_grid: EmptyGrid, endo_grid: CartesianGrid, interp_type: object, i: object, s: object):
    return eval_s(itp, exo_grid, endo_grid, interp_type, s)

@multimethod
def eval_ms(itp: object, exo_grid: EmptyGrid, endo_grid: CartesianGrid, interp_type: object, m: object, s: object):
    return eval_s(itp, exo_grid, endo_grid, interp_type, s)
